###### Antes tenemos que abrir ngrok.exe y pegar 
# 'ngrok config add-authtoken 2YWhR7jWZvP2sgtuSdC11FNWQvp_4bBoEUH1Vja45mrWaUHMZ'
# luego 'ngrok http http://localhost:8080'
...
def telegram_bot_sendtext(chat_id, bot_message):
    bot_token = '6918162572:AAG-J0rrIBhv1LGcXn_-occ6_QV7uT39sJU'
...
if __name__ == '__main__':
    bot_token = '6918162572:AAG-J0rrIBhv1LGcXn_-occ6_QV7uT39sJU'
    ngrok_url = 'https://9b32-2a0c-5a80-e50a-8800-d183-c1ae-7cca-6bbb.ngrok-free.app' # Actualizar con tu URL de Ngrok
